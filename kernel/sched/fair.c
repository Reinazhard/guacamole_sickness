...
static unsigned int __maybe_unused normalized_sysctl_sched_latency	= 6000000ULL;
...
static unsigned int __maybe_unused normalized_sysctl_sched_wakeup_granularity	= 1000000UL;
...
place_entity(struct cfs_rq *cfs_rq, struct sched_entity *se, int flags)
{
	...
	int rel_deadline = !!(flags & ENQUEUE_REL_DEADLINE);
